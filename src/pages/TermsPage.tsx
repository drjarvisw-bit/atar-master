...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-black/45 mb-4">Last updated: 16 February 2026</p>

      <div className="space-y-6 text-black/55 leading-relaxed">
        <section>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">3. Accounts</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">4. Free and Pro Plans</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">5. Payments & Subscriptions</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">6. Content & Intellectual Property</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">7. Acceptable Use</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">8. Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-black mb-3">12. Contact Us</h2>
          <p>
            If you have any questions about these Terms, please contact us at{' '}
            <a href="mailto:drjarvisw@gmail.com" className="text-black underline hover:text-black/70">drjarvisw@gmail.com</a>.
          </p>
        </section>
      </div>
